...
echo '<a href="' . $params->get('twitter') . '" target="_blank" class="icontwitter" /><img src="images/icons/twitter.png" alt="twitter" title="twitter" /></a>';
...
echo '<form class="autress"><select class="autressites" type="text" value="" placeholder="' . JText::_('MOD_CAMPINGS_AUTRES_SITES') . '" />';
