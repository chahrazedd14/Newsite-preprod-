...
if ($typemenu == 'camping') : $classbody = 'etablessiment ';
elseif ($typemenu == 'campings') : $classbody = 'etablessiments ';
else : $classbody = $typemenu;
endif;
if ($typemenu == 'tipopromotion' || $typemenu == 'tipopromotions' || $typemenu == 'cms') : $classbody = 'tipopromotion cms';
endif;
if ($lang == 'partenaires' and $typemenu == 'campings') : $classbody = ' etablessiments tipopromotion cms ';
endif;
...
<head>
    ...
    <script src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/js/1.12.1jquery-ui.min.js"
        type="text/javascript"></script><!-- Latest compiled and minified CSS -->
...
<body id="page<?php echo $itemId; ?>" class="<?php echo $classbody; ?>">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5M292KK" height="0" width="0"
    ...
    <div class="contheaderprinc">
        <header
            class=" <?php if ($typemenu == 'camping') : ?> headerpageetab <?php else : ?> container <?php endif; ?>">
            <!-- <div class="row"> -->
    ...
    <aside id="rechercherslide">
        <div class="container">
            <div class="row">
                <div class="col-12  <?php if ($itemid == 101 or $typemenu == 'campings') : echo 'col-lg-7';
                                            endif; ?>">
                    <div class="row">
                        <div class="col-12">
                            <div id="logotop">
...
if ($dispositivo == 1) : ?>
    ...
    <body id="page<?php echo $itemId; ?>" class="webmobile <?php echo $classbody; ?>">
        ...
        <div class="container titleespritclubs text-center">
            <h2><strong>L'esprit Club</strong> mmv<br />une montagne d'émotions !</h2>
        </div>
