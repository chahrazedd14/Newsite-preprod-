...
if (!isset($_POST['envoi'])) {
   ...
   if (($nom != '') && ($email != '') && ($objet != '') && ($message != '')) {
      ...
      echo '<p>' . $message_formulaire_invalide . ' <a href="indexTest.html">Retour au formulaire</a></p>' . "\n";
   };
}; // fin du if (!isset($_POST['envoi']))
?>
Améliorations
Ceci est un exemple simple, mais fonctionnel. Vous pouvez toujours l'améliorer en rajoutant des champs (lisez les
articles sur les formulaires et leur traitement pour plus de détails sur les champs et leur récupération). Vous pouvez
également effectuer le formulaire et son traitement dans la même page, afin qu'en cas d'erreur, le visiteur n'ait pas à
tout resaisir.
...
// Par exemple si vous mettez ce script sur votre site "test-site.com", mettez votre email @test-site.com comme expéditeur (par exemple contact@test-site.com)
// Si vous ne changez pas cette variable, vous risquez de ne pas recevoir de formulaire.
$email_expediteur = 'shera.mng@gmail.com';
$nom_expediteur = 'shera.mng@gmail.com';
