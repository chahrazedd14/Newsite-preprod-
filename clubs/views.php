...
function printmoduleclub($elements, $directorio, $lang, $saison, $promotions, $lienlang)
{
    ...
    if ($mobile == 0) : echo ' blancbackground';
    endif;
    echo '">';
    echo '<div class="row">';
    ...
    foreach ($elements as $element) :
        ...
        if (isset($element->nom)) :
            ...
            echo '" ';
            if ($mobile == 1) : echo ' class=" blancbackground " ';
            endif;
            echo ' target="_blank">';
            ...
            if ($mobile == 1) : echo ' pl-3 pr-3 pb-3';
            endif;
            echo '">';
